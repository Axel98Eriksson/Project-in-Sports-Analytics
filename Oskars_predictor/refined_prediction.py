...
home_goals_model_po = joblib.load('Oskars_predictor/home_goals_model_full.pkl')
away_goals_model_po = joblib.load('Oskars_predictor/away_goals_model_full.pkl')
home_goals_model_xgb = joblib.load('Oskars_predictor/home_goals_model_xgb_full.pkl')
away_goals_model_xgb = joblib.load('Oskars_predictor/away_goals_model_xgb_full.pkl')
home_goals_model_rf = joblib.load('Oskars_predictor/home_goals_model_rf_full.pkl')
away_goals_model_rf = joblib.load('Oskars_predictor/away_goals_model_rf_full.pkl')
draw_model = joblib.load('Oskars_predictor/draw_model_full.pkl')  

# Function to simulate the match with draw probability boost
def simulate_match_with_draw_boost(home_team, away_team, country, home_ranking, away_ranking, home_avg_goals_scored, away_avg_goals_scored, home_avg_goals_conceded, away_avg_goals_conceded, home_wins, away_wins, home_losses, away_losses, home_draws, away_draws, n_simulations=2000, draw_boost=1.3):
