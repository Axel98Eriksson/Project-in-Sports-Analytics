...
knockout_stage_matches = [
    ...
    ("2024-06-30", "Round of 16", knockout_positions["1C"], knockout_positions["2A"], "UEFA Euro"),
    ("2024-06-30", "Round of 16", knockout_positions["1D"], top_4_third_placed_teams[1][0], "UEFA Euro"),
    ("2024-07-01", "Round of 16", knockout_positions["1E"], top_4_third_placed_teams[2][0], "UEFA Euro"),
    ("2024-07-01", "Round of 16", knockout_positions["1F"], knockout_positions["2E"], "UEFA Euro"),
    ("2024-07-02", "Round of 16", knockout_positions["1A"], knockout_positions["2D"], "UEFA Euro"),
    ("2024-07-02", "Round of 16", knockout_positions["1B"], top_4_third_placed_teams[3][0], "UEFA Euro")
]
